...
export class EventService {
  ...
  getEventsBetweenDates(from: NgbDate, to: NgbDate): Observable<any> {
    ...
    return this.http.get<any>(this.baseURL + '?timestamp__gte=' + from_str + '&timestamp__lte=' + to_str + '&event_type=CO', httpOptions)
  }
